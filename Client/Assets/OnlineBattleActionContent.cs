...
public class OnlineBattleActionContent : ObjectContents
{
    ...
    public OnlineBattleActionContentState State
    {
        set
        {
            ...
            else if (_state == OnlineBattleActionContentState.AskingSurrender)
            {
                _actionSelectBox.UIState = GridLayoutSelectBoxState.NONE;
            }
            else if (_state == OnlineBattleActionContentState.FadingOut)
            {
                _actionSelectBox.UIState = GridLayoutSelectBoxState.NONE;
            }
            else if (_state == OnlineBattleActionContentState.Inactiving)
            {
                _actionSelectBox.gameObject.SetActive(false);
                _actionSelectBox.UIState = GridLayoutSelectBoxState.NONE;
    ...
    public override void SetNextAction(object value = null)
    {
        ...
        switch (_state)
        {
                    ...
                    if (value is Define.InputSelectBoxEvent)
                    {
                        ...
                        if (inputEvent == Define.InputSelectBoxEvent.SELECT)
                        {
                            ...
                            else if (selectedAction == "Pokemon")
                            {
                                ...
                                State = OnlineBattleActionContentState.FadingOut;
                            }
            ...
            case OnlineBattleActionContentState.AnsweringSurrender:
                ...
                break;
            case OnlineBattleActionContentState.FadingOut:
                {
