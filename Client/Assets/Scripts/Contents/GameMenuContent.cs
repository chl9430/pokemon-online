...
public class GameMenuContent : ObjectContents
{
    ...
    public GameMenuContentState State
    {
        set
        {
            ...
            if (_state == GameMenuContentState.Choosing_Menu)
            {
            ...
            case GameMenuContentState.Choosing_Menu:
                {
                    if (value is Define.InputSelectBoxEvent)
                    {
                        ...
                        else if (inputEvent == Define.InputSelectBoxEvent.SELECT)
                        {
                            ...
                            else if (_selectBox.GetSelectedBtnData() as string == "Pokemon")
                            {
                                ...
                                GameContentManager.Instance.OpenPokemonList(Managers.Object.MyPlayerController.MyPokemons, actionBtnNames, "FadeOut");
