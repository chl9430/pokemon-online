            ...
            case PlayerContentState.RECEIVER_ACCEPT_TO_BATTLE:
                {
                    ...
                    ContentManager.Instance.FadeOutSceneToMove(Define.Scene.Battle, "FadeOut", enterBattle);
                }
                break;
            case PlayerContentState.RECEIVER_ACCEPT_TO_EXCHANGE:
                {
                    ...
                    ContentManager.Instance.FadeOutSceneToMove(Define.Scene.PokemonExchange, "FadeOut", enterExchangePacket);
